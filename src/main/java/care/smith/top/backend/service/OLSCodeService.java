...
public class OLSCodeService {
    ...
    @Autowired
    public void setTerminologyServiceEndpoint(@Value("${coding.terminology-service}") String terminologyServiceEndpoint) {
        terminologyService = WebClient.builder()
    ...
    public List<Code> getCode(List<String> include, String term, CodeSystem codeSystems, Integer page) {
        return null;
    }

    public List<Code> getCodeSuggestions(List<String> include, String term, List<String> codeSystems, Integer page) {
        return Arrays.stream(terminologyService.get()
                .uri(uriBuilder -> uriBuilder
                        .path("/select")
                        .queryParam("q", term)
                        .queryParam("start", page)
                        .queryParam("rows", suggestionsPageSize)
                        .queryParam("ontology", codeSystems == null ? "" : String.join(",", codeSystems))
                        .build()
                )
                .retrieve()
