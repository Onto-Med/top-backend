...
@SpringBootTest
@ContextConfiguration(classes = TopBackendApplication.class)
class SubjectRepositoryTest extends AbstractJpaTest {
  ...
  void testCascadeInsert() {
    ...
    SubjectResourceDao height =
        new SubjectResourceDao(dataSourceId, "123", subject, "http://loinc.org/", "3137-7").now();
