...
class DirectoryRepositoryTest extends RepositoryTest {
  ...
  void findByNameContaining() {
    ...
    assertThat(directoryRepository.findAllByName(name1)).size().isEqualTo(2);
    assertThat(directoryRepository.findAllByDescription("desc"))
        .size()
        .isEqualTo(1);
  }
  ...
  void findByType() {
    ...
    assertThat(directoryRepository.findAllByType("Organisation"))
        .size()
        .isEqualTo(1);
  }
}
